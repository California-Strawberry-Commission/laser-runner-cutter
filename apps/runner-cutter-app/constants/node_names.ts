...
export const DETECTION_NODE_NAME = "/detection_node";
...
export const FURROW_PERCEIVER_BACKWARD_NODE_NAME = "/furrow_perceiver_backward";
export const GUIDANCE_BRAIN_NODE_NAME = "/guidance_brain";
