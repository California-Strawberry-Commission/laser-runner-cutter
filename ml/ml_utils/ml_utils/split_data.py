...
if __name__ == "__main__":
    ...
    images_parser.add_argument(
        "--input_dir",
        required=True,
        help="Path to the directory containing the images to split",
    )
    images_parser.add_argument(
        "--output_dir",
        required=True,
        help="Path to the directory where the split images will be written to",
    )
    images_parser.add_argument(
        "--val_ratio",
        type=float,
    ...
    yolo_labels_parser.add_argument(
        "--input_dir",
        required=True,
        help="Path to the directory containing the YOLO label files to split",
    )
    yolo_labels_parser.add_argument(
        "--split_images_dir",
        required=True,
        help="Path to the directory containing the train/val/test directories containing split image files",
    )
    yolo_labels_parser.add_argument(
        "--output_dir",
        required=True,
        help="Path to the directory where the split YOLO label files will be written to",
    )
    ...
    masks_parser.add_argument(
        "--input_dir",
        required=True,
        help="Path to the directory containing the instanced masks subdirs to split",
    )
    masks_parser.add_argument(
        "--split_images_dir",
        required=True,
    ...
    masks_parser.add_argument(
        "--output_dir",
        required=True,
        help="Path to the directory where the split instanced masks subdirs will be written to",
    )
