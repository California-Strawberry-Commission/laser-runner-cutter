...
def generate_launch_description():
    parameters_file = os.path.join(
        get_package_share_directory("runner_cutter_control_cpp"),
        "config",
        "parameters.yaml",
    )
    ...
    laser_control_cpp_launch_node = Node(
    ...
    runner_cutter_control_cpp_launch_node = Node(
    ...
    return LaunchDescription(
        [
            ...
            laser_control_cpp_launch_node,
            camera_control_launch_node,
            runner_cutter_control_cpp_launch_node,
        ]
    )  # type: ignore
