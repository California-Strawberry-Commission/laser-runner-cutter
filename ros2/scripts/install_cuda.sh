...
test -e opencv.zip || wget -O opencv.zip https://github.com/opencv/opencv/archive/refs/tags/${opencv_version}.zip
test -e opencv-${opencv_version} || unzip opencv.zip
test -e opencv_contrib.zip || wget -O opencv_contrib.zip https://github.com/opencv/opencv_contrib/archive/refs/tags/${opencv_version}.zip
test -e opencv_contrib-${opencv_version} || unzip opencv_contrib.zip
...
-D CUDNN_LIBRARY=${cudnn_lib_dir}/libcudnn.so \
..
