...
setup_layout = [
    ...
    [
        sg.Text("Tracking Laser Step Size"),
        sg.Slider(
            range=(1, 20),
            orientation="h",
            size=(10, 20),
            key="-SLIDER_RESOLUTION-",
            default_value=5,
        ),
    ],
...
while True:
    ...
    if event == "Start Test":
        ...
        if laser_safety_conf:
            ...
            rec = cv2.VideoWriter(rec_name, 0, 20.0, size)
